package com.kindol.o2o.web.wechat;
...
import com.kindol.o2o.util.wechat.WechatUtil;
 ...
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxdb0a6572b2bfc06a&redirect_uri=http://120.79.241.53/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
...
public class WeChatLoginController {
    ...
    public String doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        //roleType判断是为去展示页面（1），还是店家管理系统（2）
        ...
        if (null != code) {
            ...
            auth = wechatAuthService.getWechatAuthByOpenId(openId);         //判断后台是否有此微信账号
        }

        // 前面获取到openId后，可以通过它去数据库判断该微信帐号是否在我们网站里有对应的帐号，
        // 没有的话这里可以自动创建上，直接实现微信与 网站的无缝对接。
        if (auth == null){
